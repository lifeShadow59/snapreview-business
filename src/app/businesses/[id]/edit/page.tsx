        ...
        try {
            ...
            if (response.ok) {
                ...
                setFormData({
                    ...
                    business_type_id: businessData.business_type_id || 0,
                ...
                if (businessData.phone_numbers && businessData.phone_numbers.length > 0) {
                    setPhoneNumbers(businessData.phone_numbers);
                }

                // Populate email addresses
                if (businessData.email_addresses && businessData.email_addresses.length > 0) {
                    setEmailAddresses(businessData.email_addresses);
                }
            } else {
